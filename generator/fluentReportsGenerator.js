...
class frSection { // jshint ignore:line
    ...
    constructor(report, options = {}) {
        ...
        this._counters = options && options.counters || {subReportCounter:0,groupCounter:0}
        this._children = [];
        ...
        const showSettingsOfCurrentTree = (tree) => {
            ...
            if (tree.setting) {
                ...
                if(tree.setting.id === "totals"){
                    ...
                    editTotals.addEventListener("click", function () {
                        this.subReportTotalsBrowse(tree.treePathing,tree.setting.value || {},getData(tree), this._parent, (value) => {
