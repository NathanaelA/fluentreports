        ...
        if (typeof value.type !== 'undefined') {
            ...
            if (typeof info.data[value] === 'undefined' && typeof info.state.parentData[value] !== 'undefined') {
                ...
                if(inOptions.formatFunction){
                    let functionData;
                    if(!functionData && typeof inOptions.formatFunction === "number") {
                        functionData = this._formatterFunctions[inOptions.formatFunction - 2];
                    }
                    ...
                    if(functionData) {
                        ...
                        if(functionData.class === "function" ){
                            functionData.function(info.data,(output)=>{
                                callback(key,output);
                            });
                            return;
                        }
                        else if(functionData.class === "string" ) {
                            this._handleFunction(functionData, info, (output) => {
                                callback(key,output);
                            });
                            return
                        }
