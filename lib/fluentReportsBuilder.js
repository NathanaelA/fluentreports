...
class ReportBuilder{
    ...
    parseReport(reportDesignLayout, reportData){
        ...
        if(reportDesignLayout && typeof reportDesignLayout.version !== "undefined"){
            if(reportDesignLayout.version !== 1){
        ...
        else if(reportDesignLayout.data != null){
