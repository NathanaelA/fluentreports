                    ...
                    if(functionData) {
                        ...
                        if(functionData.class === "function" ){
                            ...
                            if (!functionData.func) {
                                functionData.func = new Function('row', 'value', 'callback', functionData.function); // jshint ignore:line
                            }
                            functionData.func( info.data, info.data[key], (output)=>{
                                callback(key,output);
                            });
                            return
                        }
                ...
                if(setting.settings.formatFunction){
                    ...
                    if(functionData) {
                        ...
                        if(functionData.class === "function" ){
                            ...
                            if (!functionData.func) {
                                functionData.func = new Function ('row', 'value', 'done', functionData.function); // jshint ignore:line
                            }
                            functionData.func(info.data, info.data[setting.field], (output)=>{
                                this._handleOptions(setting.settings, info, (options) => {
                                    info.report.print(output, options, callback);
                                });
                            });
